...
{
    /// <inheritdoc />
    public partial class CriarEstruturaAdministrador : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimiteAlunos = table.Column<int>(type: "int", nullable: true),
                    LimiteUnidades = table.Column<int>(type: "int", nullable: true),
